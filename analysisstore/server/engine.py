...
class AnalysisHeaderHandler(DefaultHandler):
    ...
    def initialize(self):
        ...
        self.astore = self.settings["astore"]
        self.insertables = {
            "insert_analysis_header": self.astore.insert_analysis_header
        }
...
class DataReferenceHeaderHandler(DefaultHandler):
    ...
    def initialize(self):
        self.astore = self.settings["astore"]
        self.insertables = dict(
            insert_data_reference_header=self.astore.insert_data_reference_header
        )
        self.queryables = {
            "find_data_reference_header": self.astore.find_data_reference_header
        }
...
class DataReferenceHandler(DefaultHandler):
    ...
    def initialize(self):
        self.astore = self.settings["astore"]
        self.insertables = dict(
            insert_data_reference=self.astore.insert_data_reference,
